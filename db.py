...
class SqlHandler(ISqlHandler):
    ...
    def select(self, count=None, conditions=None):
        ...
        if count:
            ...
            return query.order_by(Proxy.update_time.desc(), Proxy.use_times, Proxy.speed, Proxy.score.desc()).limit(count).all()
        else:
            ...
            return query.order_by(Proxy.update_time.desc(), Proxy.use_times, Proxy.speed, Proxy.score.desc()).all()
        return
